  ...
  return h("div", {},
    ...
    h("section", { class: "reveal", style: { marginTop: "40px" } },
      h("div", { class: "grid grid-3" }, ...[
        ["01", "Decide", "A real situation with imperfect numbers and two answers that both look right."],
        ["02", "See the reasoning", "What the evidence says, why the model weighs it that way, and what would change its mind."],
        ["03", "Apply it", "One principle and one next move you can use on your next customer call."],
      ].map(([n, t, d]) => h("div", { class: "card card-quiet" }, h("p", { class: "tag" }, n), h("h3", { style: { marginTop: "10px" } }, t), h("p", { class: "muted", style: { marginTop: "6px", fontSize: "var(--fs-small)" } }, d))))),
