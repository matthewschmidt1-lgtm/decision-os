...
export default function Home() {
  ...
  return h("div", {},
    h("section", { class: "reveal" },
      ...
      h("p", { class: "hero-sub" }, "Decision OS puts you in the moment. A Kroger decline. A Publix promo request. A distributor loading up before quarter-end. You make the call."),
      h("p", { class: "hero-sub", style: { marginTop: "14px" } }, "Then Decision OS shows you what matters: the evidence, reasoning, and principle behind the recommendation."),
    ),
