...
export default function Home() {
  ...
  return h("div", {},
    h("section", { class: "reveal" },
      ...
      h("p", { class: "hero-sub" }, "Sales doesn't happen in spreadsheets. It happens in moments: a key account decline, a promo request, a distributor loading up before quarter-end. You have to make the call."),
      h("p", { class: "hero-sub", style: { marginTop: "14px" } }, "Decision OS puts you in those moments and makes the thinking visible."),
      h("p", { class: "hero-sub", style: { marginTop: "14px" } }, "What matters? What doesn't? What evidence should you trust? What tradeoffs are you making?"),
