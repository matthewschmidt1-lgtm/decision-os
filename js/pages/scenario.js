...
export default async function Scenario({ id, params }) {
  ...
  return h("article", {},
    h("header", { class: "reveal" },
      ...
      h("div", { style: { marginTop: "36px" } }, eyebrow("The situation")), h("h1", { style: { marginTop: "18px", fontSize: "var(--fs-h1)", maxWidth: "28ch" } }, s.situation)),
    h("section", { class: "section reveal", style: { marginTop: "56px" } }, h("h2", { style: { fontSize: "var(--fs-h3)" } }, "What you know"), h("div", { style: { marginTop: "16px" } }, evidence(s.evidence, { optionTones: false })),
